...
export const MATH_10_QUESTIONS: Question[] = [
  ...
  { id: 'q10_8', type: 'multiple_choice', level: 'ThongHieu', topicName: 'Mệnh đề và Tập hợp', lessonName: 'Khoảng đoạn', outcome: 'YCCĐ 3', content: 'Biểu diễn tập hợp $S = \\{x \\in \\mathbb{R} \\mid -1 < x \\le 4\\}$ trên trục số là:', options: [{ key: 'A', text: 'Nửa khoảng $(-1; 4]$' }, { key: 'B', text: 'Đoạn $[-1; 4]$' }, { key: 'C', text: 'Khoảng $(-1; 4)$' }, { key: 'D', text: 'Nửa khoảng $[-1; 4)$' }], correctAnswer: 'A', solution: '$(-1; 4]$.' },
  ...
  // PHẦN III: 6 CÂU TRẢ LỜI NGẮN (ĐÃ ĐÓNG CÂU 22 CHUẨN XÁC)
  ...
  { id: 'q10_22', type: 'short_answer', level: 'VanDung', topicName: 'Mệnh đề và Tập hợp', lessonName: 'Tập hợp', outcome: 'YCCĐ 3', content: 'Có bao nhiêu số nguyên $x$ thuộc $A \\cap B$ biết $A = (-5; 3)$ và $B = [-1; 6)$?', correctAnswer: '4', solution: '$x \\in \\{-1; 0; 1; 2\\}$, có 4 số nguyên.' },
];

// ==============================================================
// 3. NGÂN HÀNG TRỌN BỘ 22 CÂU TOÁN 11 CHUẨN GDPT 2018
// ==============================================================
export const MATH_11_QUESTIONS: Question[] = [
  ...
  { id: 'q11_4', type: 'multiple_choice', level: 'NhanBiet', topicName: 'Cấp số nhân', lessonName: 'Cấp số nhân', outcome: 'YCCĐ 1', content: 'Cho cấp số nhân $(u_
